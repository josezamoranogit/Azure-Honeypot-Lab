...
##  Conclusion
<br></br>
The final visualizations include a "World Heat Map" & "Top 10 Usernames attempted". These visualizations are a great source of information because they make large sets of data easier to read. The hardest challenge during this lab was the creation of the powershell script that was used to interact with the IPGeolocation API. I would have liked to store my API key in Azure Key Vault since it's best practice however, for the purposes of this lab I think it gets the job done. The most interesting part for me was creating the KQL queries as I had already had some experience with it. In the end, I learned a lot from interacting with API's, managing logs in Log Analytics Workspace, and data visualizations in Azure Sentinel. I highly recommmend this lab to anyone looking to get some experience in any of these areas.
<br></br>
